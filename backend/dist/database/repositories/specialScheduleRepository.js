...
class SpecialScheduleRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.specialSchedule.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'description',
                'scheduleDate',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let record = yield options.database.specialSchedule.findOne({
                where: {
                    id,
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const include = [];
            const currentTenant = sequelizeRepository_1.default.getCurrentTenant(options);
            const record = yield options.database.specialSchedule.findOne({
                where: {
                    id,
                    tenantId: currentTenant.id,
                },
    ...
    static filterIdsInTenant(ids, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.specialSchedule.findAll({
                attributes: ['id'],
                where,
            });
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            return options.database.specialSchedule.count({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.description) {
                    whereAnd.push(sequelizeFilterUtils_1.default.ilikeIncludes('specialSchedule', 'description', filter.description));
                }
                if (filter.scheduleDateRange) {
                    const [start, end] = filter.scheduleDateRange;
            ...
            let { rows, count, } = yield options.database.specialSchedule.findAndCountAll({
                where,
                include,
            ...
            if (query) {
                whereAnd.push({
                    [Op.or]: [
                        ...
                        {
                            [Op.and]: sequelizeFilterUtils_1.default.ilikeIncludes('specialSchedule', 'description', query),
                        },
                    ],
                });
            }
...
exports.default = SpecialScheduleRepository;
//# sourceMappingURL=specialScheduleRepository.js.map